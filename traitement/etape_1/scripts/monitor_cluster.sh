#!/bin/bash
# Script de surveillance de l'état du cluster EMR
...
echo "=================================================="
echo "🔍 SURVEILLANCE DU CLUSTER EMR"
echo "=================================================="
...
while true; do
    ...
    case $STATE in
        "STARTING")
            ...
            ;;
        "BOOTSTRAPPING")
            echo "[$TIMESTAMP] 🟡 BOOTSTRAPPING - Installation des dépendances Python..."
            ;;
        "RUNNING")
            echo "[$TIMESTAMP] 🟢 RUNNING - Configuration en cours..."
            ;;
        "WAITING")
