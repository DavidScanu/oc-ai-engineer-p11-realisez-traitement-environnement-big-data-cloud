#!/bin/bash
# Script de création du cluster EMR pour l'étape 2 - Feature Extraction + PCA
...
echo "=================================================="
echo "🚀 CRÉATION DU CLUSTER EMR - ÉTAPE 2"
echo "=================================================="
show_config
echo ""
echo "💰 Coût estimé: ~0.80€/heure"
echo "   (m5.2xlarge: ~0.384$/h × 3 instances × 1.2 = ~1.38$/h)"
echo ""
echo "⚠️  Auto-terminaison après 4h d'inactivité"
echo "⚠️  Pensez à terminer le cluster après usage !"
echo ""
...
echo "   (Le bootstrap installe TensorFlow, scikit-learn, etc.)"
echo "=================================================="
